...
from datasets.SoftwareNet import SoftwareNetDataset
...
def experiment_name_1():
    ...
    specific_log = 'Log_2021-11-25_19-16-11'
    

    start = specific_log
    end = specific_log
    
    # start = 'Log_2021-11-23_13-24-30'
    # end = 'Log_2021-11-23_17-02-55'
    ...
    logs_names = ['synthetic point cloud']
...
if __name__ == '__main__':
    ...
    if config.dataset_task == 'classification':
        ...
        if config.dataset.startswith('SoftwareNet'):
            dataset = SoftwareNetDataset(config, load_data=False)
